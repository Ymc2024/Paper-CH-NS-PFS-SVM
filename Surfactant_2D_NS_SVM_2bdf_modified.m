function [phi,rho,u,v,p,alpha] = Surfactant_2D_NS_SVM_2bdf_modified(pde,domain,Nx,Ny,time,option)
...
dir_data = [pde.name,'SVM_bdf2_modified/data'];
...
%         tmp2 = pde.rho_t(xx,yy,t)  - Mrho .* lap_diff(rhs_omega);
    ...
    alpha_initial = 0;
        alpha = fsolve(@(alpha) non_fun_alpha(alpha,u_new1,u_new2,u1,u0,v_new1,v_new2,v1,v0,phi_new1,phi_new2,phi1,phi0,rho_new1,rho_new2,rho1,rho0,...
                            phi_star_new,rho_star_new,phi_bar,rho_bar,tmp1,tmp2,tmpu,tmpv),alpha_initial,opts);
...
function r = non_fun_alpha(alpha,u_new1,u_new2,u1,u0,v_new1,v_new2,v1,v0,phi_new1,phi_new2,phi1,phi0,rho_new1,rho_new2,rho1,rho0,...
                            phi_star_new,rho_star_new,phi_bar,rho_bar,rhs1,rhs2,rhs3,rhs4)
global dt Mphi Mrho upsilon gamma1 gamma2 epsilon S1 S2 eta
    ...
    mu_phi_new = -gamma1 * lap_diff((phi_new1 + alpha.*phi_new2 )) + E_derivative_phi(phi_star_new,rho_star_new)+S1/epsilon^2 *((phi_new1 + alpha.*phi_new2) - phi_bar) ;
    mu_rho_new = -gamma2 * lap_diff((rho_new1 + alpha.*rho_new2 )) + E_derivative_rho(phi_star_new,rho_star_new)+S2/eta^2 *((rho_new1 + alpha.*rho_new2 ) - rho_bar) ;
